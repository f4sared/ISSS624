...
Now, we do not need the column shapeName anymore, so we do the following:
...
To view the outcome, we save the output as a png: \
<https://stackoverflow.com/questions/11444743/how-to-adjust-sizes-of-x-axis-in-dendrogram-r>

```{r}
png("plotdendogram.png",width=12800,height=6400)
plot(hclust_ward, cex = 1.0)
dev.off()
```

Please open the png in a new tab to be able to zoom in:
